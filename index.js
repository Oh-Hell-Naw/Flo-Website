...
for (let i = 1; i <= 32; i++) {
    ...
    funnyTextWrapper === null || funnyTextWrapper === void 0 ? void 0 : funnyTextWrapper.appendChild(span);
}
const socials = [
    {
        name: "Discord",
...
for (const social of socials) {
    ...
    a.appendChild(img);
    socialsWrapper === null || socialsWrapper === void 0 ? void 0 : socialsWrapper.appendChild(a);
}
const projects = [
    {
        name: "PythonIDE",
...
for (const project of projects) {
    ...
    projectsWrapper === null || projectsWrapper === void 0 ? void 0 : projectsWrapper.appendChild(wrapper);
}
